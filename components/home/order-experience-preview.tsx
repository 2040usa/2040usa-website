  ...
  return (
    <section id="experience" className="min-w-0 rounded-control border border-border bg-panel shadow-[var(--card-shadow)]" aria-labelledby="experience-heading">
      <div className="border-b border-border p-5 sm:p-6">
        <div className="flex flex-wrap items-start justify-between gap-4"><div><SectionLabel>Order experience</SectionLabel><h2 id="experience-heading" className="mt-4 font-display text-3xl font-semibold text-text-primary sm:text-4xl">A clear route from file to pickup.</h2></div><StatusBadge tone="accent">Example</StatusBadge></div>
