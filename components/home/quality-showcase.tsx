...
export function QualityShowcase() {
  return (
    <section id="quality" className="rounded-control border border-border bg-panel p-5 shadow-[var(--card-shadow)] sm:p-6" aria-labelledby="quality-heading">
      ...
      <h2 id="quality-heading" className="mt-5 font-display text-3xl font-semibold leading-tight text-text-primary sm:text-4xl">Production checks at the points that matter.</h2>
      ...
      <p className="mt-4 text-xs text-text-muted">Exact checks depend on artwork and material.</p>
    </section>
  );
}
