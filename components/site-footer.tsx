  ...
  return (
    <footer className="bg-panel pt-16" aria-label="Site footer">
      <div className="page-shell grid gap-12 border-b border-border pb-16 lg:grid-cols-[1.2fr_0.8fr]">
        <div><p className="font-display text-5xl uppercase leading-none text-text-primary sm:text-7xl">Ready when<br /><span className="text-accent">your art is.</span></p><a href="#start" className="mt-8 inline-flex items-center gap-2 border-b border-accent pb-2 font-mono text-xs font-bold uppercase tracking-widest text-text-primary focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-accent">Start a Print <ArrowUpRight size={16} /></a></div>
